  ...
  return (
    <DashboardLayout>
      ...
      <div className="supportcontainer pb-20 pt-4">
        <div onClick={openModal} className="list py-6 px-4 rounded-lg mt-4 bg-white flex items-center justify-between">
        ...
        <div onClick={openModal} className="list py-4 px-6 rounded-lg mt-4 bg-white flex items-center justify-between">
          <div className="title flex items-center">
