...
const RegisterPage = () => {
  ...
  return (
    <Layout>
      <Section>
        <div className='flex items-center justify-center mx-auto sm:pt-10 py-20 sm:w-3/6'>
          <div className='container w-full sm:w-500 mx-auto sm:pt-20'>
            {/* <div className="flex justify-center items-center pb-6">
              <Logo isBage />
            </div> */}
            <h2 className='mb-2 text-center text-xl sm:text-3xl leading-9 font-extrabold text-gray-100'>
