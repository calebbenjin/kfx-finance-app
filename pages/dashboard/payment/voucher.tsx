...
const SignupSchema = Yup.object().shape({
  voulcherNum: Yup.string().required(
  ...
  return (
    <DashboardLayout>
      ...
      <div className="container">
        <PaymentForm>
          <PageTitle title="Enter your payment voucher" />
              ...
              <div className="flex flex-wrap items-center justify-between">
                <div className="flex w-0 flex-1 items-center">
                  ...
                  <p className="ml-3 truncate font-medium text-white">
                    <span className="md:hidden">Don&lsquo;t have a Voucher Number?</span>
                    <span className="hidden md:inline">Don&lsquo;t have a Voucher Number?</span>
                  </p>
                </div>
                  ...
                  <div>
                    <div>
                      ...
                      <FormInput
                        ...
                        name="voulcherNum" placeholder="Enter Voucher Number"
                        type="text"
                      />
                    </div>
                  </div>
