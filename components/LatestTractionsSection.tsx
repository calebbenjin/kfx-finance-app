      ...
      <SectionWrapper>
        <div className='container mx-auto py-6 xl:py-20 grid grid-cols-1 md:grid-cols-1 md:gap-6 lg:grid-cols-2 lg:gap-6'>
          <div className='content-wrapper xl:text-left sm:text-center lg:pl-10 xl:pl-10 xl:pt-10 pt-10'>
            <h2 className='md:text-1xl font-bold capitalize text-blue'>
              Our Feature
            </h2>
            <h1 className='text-3xl my-5 lg:text-5xl xl:text-5xl md:my-4 xl:my-10 font-semibold tracking-normal'>
            ...
            <Link
              href='/'
              className='core-btn shadow-2xl bg-blue text-gray-100 py-4 px-7 mr-4'>
              Tack your money
            </Link>
          </div>
