      ...
      <div className="container">
        <div className="p-10 md:p-20 rounded-6 grid grid-cols-1 md:grid-cols-1 md:gap-10 lg:grid-cols-2 lg:gap-20">
          <div className="content">
            ...
            <h1 className="text-3xl text-white my-5 lg:text-4xl xl:text-5xl md:my-4 xl:my-10 font-bold tracking-normal">Track your crytpo portfolio on the best way possible</h1>
