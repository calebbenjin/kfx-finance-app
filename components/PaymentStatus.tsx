      ...
      <div className='bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4'>
        <div className=''>
          <div className='mt-3 text-center sm:mt-0 sm:text-left'>
            <Dialog.Title
              as='h3'
              className='sm:text-2xl text-center mb-2 font-medium leading-6 text-blue'>
            ...
            <div className='mt-2'>
              <div className='cardHeader flex items-center justify-between'>
                <h2 className='font-bold sm:text-lg text-gray-400 mt-5'>
                  ...
                  <>
                    ...
                    <div className='list flex items-center mb-2 justify-between border-b pb-2'>
                      ...
                      <p className='font-semibold text-gray-500 text-sm sm:text-lg'>
                        ...
                        {formatCurrency(Number(data?.sendAmount))}{' '}
                      </p>
                    </div>
                    <div className='list flex items-center mb-2 justify-between border-b pb-2'>
                      <p className='font-bold text-gray-500 text-sm sm:text-lg'>
                      ...
                      <p className='font-semibold text-gray-500 text-sm sm:text-lg'>
                        ...
                        {formatCurrency(Number(data?.recieveAmount))}{' '}
                      </p>
                    </div>
                    <div className='list flex items-center mb-2 justify-between border-b pb-2'>
                      <p className='font-bold text-gray-500 text-sm sm:text-lg'>
                    ...
                    <div className='list flex items-center mb-2 justify-between border-b pb-2'>
                      ...
                      <p className='font-semibold text-gray-500 text-sm sm:text-lg'>
                        {data?.pickupDate && dateFormater(data?.pickupDate)}
                      </p>
                    </div>
                  </>
                )}
